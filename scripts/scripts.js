...
var duarationButton = document.getElementById("duration-button");
function changeDuration(){
    var durationlabel = document.getElementById('duration-text');
    durationlabel=prompt("Enter duration:");
    duration = durationlabel;
    document.getElementById('duration-text').innerHTML = durationlabel;
    recalculate();
}
duarationButton.addEventListener("click", changeDuration);
